...
|---|---|---|---|---|
| [`airflow-s3-logging`](case-studies/airflow-s3-logging/) | [Apache Airflow](https://airflow.apache.org/) | S3 (remote task logging) | Blob Storage (Azurite locally / real Storage account optionally) | ✅ CI-verified (call pattern); ✅ full stack run end-to-end manually |
